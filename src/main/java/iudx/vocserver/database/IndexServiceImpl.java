...
class IndexServiceImpl implements IndexService{
    ...
    IndexServiceImpl(WebClient indexClient, MongoClient dbClient, Handler<AsyncResult<IndexService>> readyHandler) {
     ...
     */
    @Override
    public void insertIndex(Handler<AsyncResult<JsonObject>> resultHandler) {
