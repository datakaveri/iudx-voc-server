...
public class SearchServiceVertxEBProxy implements SearchService {
  ...
  public  void insertIndex(JsonArray body, Handler<AsyncResult<JsonObject>> resultHandler){
    ...
    _deliveryOptions.addHeader("action", "insertIndex");
  ...
  public  void deleteFromIndex(String uid, Handler<AsyncResult<Boolean>> resultHandler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "deleteFromIndex");
  ...
  public  void deleteIndex(Handler<AsyncResult<Boolean>> resultHandler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "deleteIndex");
    _vertx.eventBus().<Boolean>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public  void searchIndex(String pattern, Handler<AsyncResult<JsonArray>> resultHandler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "searchIndex");
